				...
				error:(NSError **)errPtr
{
	...
	if (![self isDisconnected])
	{
        NSLog(@"Attempting to connect while connected or accepting connections. Disconnect first.");
        [self disconnect];
...
- (BOOL)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
#if DEBUG_THREAD_SAFETY
	[self checkForThreadSafety];
#endif
	...
	if (theFlags & kForbidReadsWrites) return FALSE;
