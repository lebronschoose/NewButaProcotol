...
#define MXWechatAPPID       @"wxaa94c0af331d4b57"
// 开放平台登录https://open.weixin.qq.com的开发者中心获取AppSecret。
//#define MXWechatAPPSecret   @"https://api.mch.weixin.qq.com/pay/unifiedorder"
// 微信支付商户号
#define MXWechatMCHID       @"1394654002"
// 安全校验码（MD5）密钥，商户平台登录账户和密码登录http://pay.weixin.qq.com
// 平台设置的“API密钥”，为了安全，请设置为以数字和字母组成的32字符串。
#define MXWechatPartnerKey  @"26f02f1b212187fd8d523c47414bb06a"
